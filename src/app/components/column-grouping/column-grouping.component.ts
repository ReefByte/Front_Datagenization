...
export class ColumnGroupingComponent {
  ...
  constructor(private uploadService:UploadService, private columnGroupingService:ColumnGroupingService) {}
  ...
  removeSelection(rowIndex: number, fileName: string, selectionIndex: number): void {
